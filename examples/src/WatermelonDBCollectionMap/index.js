...
// class CollectionMap {
//   constructor(db, modelClasses) {
//     this.map = Object.create(null);
//     modelClasses.forEach((modelClass) => {
//       if (!modelClass.table) throw new Error('missing "static table"');
//       if (!db.schema.tables[modelClass.table]) throw new Error('missing in schema');
//       this.map[modelClass.table] = { modelClass, table: modelClass.table };
//     });
//     Object.freeze(this.map);
//   }
//   get(tableName) {
//     if (typeof tableName !== 'string' || !this.map[tableName]) return null;
